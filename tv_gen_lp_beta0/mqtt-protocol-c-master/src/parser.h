...
typedef struct mqtt_parser_s {
  ...
  mqtt_error_t error;
  char buffer_pending;
  uint16_t* buffer;//uint8_t* buffer; //AS_TEST
  size_t buffer_length;
} mqtt_parser_t;

void mqtt_parser_init(mqtt_parser_t* parser);
void mqtt_parser_buffer(mqtt_parser_t* parser, uint16_t* buffer, size_t buffer_length);//void mqtt_parser_buffer(mqtt_parser_t* parser, uint8_t* buffer, size_t buffer_length);//AS_TEST
mqtt_parser_rc_t mqtt_parser_execute(mqtt_parser_t* parser, mqtt_message_t* message, uint16_t* data, size_t len, size_t* nread);//mqtt_parser_rc_t mqtt_parser_execute(mqtt_parser_t* parser, mqtt_message_t* message, uint8_t* data, size_t len, size_t* nread);//AS_TEST
