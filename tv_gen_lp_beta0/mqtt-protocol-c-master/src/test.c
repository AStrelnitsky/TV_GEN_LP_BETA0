...
int main_mqtt (void) {//(int argc, char** argv) {
...
*/
  ...
  uint16_t data[] = {//uint8_t data[] = { //AS_TEST
    // type 1
    0x10,
    // length 94
    0x5e,
     ...
     0x00, 0x06, 0x73, 0x68, 0x6f, 0x75, 0x74, 0x73,
      // will message
     0x00, 0x16,0x59, 0x4f, 0x20, 0x57, 0x48, 0x41, 0x54, 0x27, 0x53, 0x20, 0x55, 0x50, 0x20, 0x4d, 0x59, 0x20, 0x48, 0x4f, 0x4d, 0x49, 0x45, 0x53,
      // username
     0x00, 0x07, 0x74, 0x68, 0x65, 0x75, 0x73, 0x65, 0x72,
      // password (md5)
     0x00, 0x20, 0x62, 0x61, 0x33, 0x63, 0x38, 0x33, 0x33, 0x34, 0x38, 0x62, 0x64, 0x64, 0x66, 0x37, 0x62, 0x33, 0x36, 0x38, 0x62, 0x34, 0x37, 0x38, 0x61, 0x63, 0x30, 0x36, 0x64, 0x33, 0x33, 0x34, 0x30, 0x65,
  };
  ...
  uint16_t* packet = malloc(packet_length);//uint8_t* packet = malloc(packet_length);//AS_TEST
